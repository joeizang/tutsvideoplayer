    ...
    const label = entry.recommendation === "replay"
        ...
        : entry.recommendation === "next"
            ...
            : entry.recommendation === "unavailable"
                ? "Unavailable"
                : "Resume";
    const percentComplete = entry.totalLessons > 0
    ...
    return (
        <li className="flex flex-wrap items-center justify-between gap-2 rounded-lg px-2 py-2 hover:bg-canvas dark:hover:bg-neutral-700">
            <div className="min-w-0 flex-1">
                ...
                <div className="mt-1.5 h-1 w-full max-w-xs overflow-hidden rounded-full bg-ink/10 dark:bg-neutral-700">
                    <div className="h-full rounded-full bg-action" style={{ width: `${percentComplete}%` }} />
                </div>
            </div>
            {entry.recommendation === "unavailable" ? (
