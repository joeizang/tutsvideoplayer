...
public static class PreparationTransitions
{
    public static bool CanTransition(PreparationJobState from, PreparationJobState to) => (from, to) switch
    {
        ...
        (PreparationJobState.Running, PreparationJobState.Blocked) => true,
        (PreparationJobState.Running, PreparationJobState.Succeeded) => true,
        (PreparationJobState.Validating, PreparationJobState.Interrupted) => true,
        (PreparationJobState.Interrupted, PreparationJobState.Failed) => true,
        (PreparationJobState.Succeeded, PreparationJobState.Queued) => true,
